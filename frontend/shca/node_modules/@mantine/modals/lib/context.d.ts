...
export type ContextModalInnerProps<TKey extends MantineModal, P = Parameters<MantineModals[TKey]>[0]['innerProps']> = keyof NonNullable<P> extends never ? {
    innerProps?: never;
} : {
    innerProps: P;
};
export type OpenContextModal<TKey extends MantineModal = string> = ModalSettings & ContextModalInnerProps<TKey>;
...
export interface ModalsContextProps {
    ...
    openContextModal: <TKey extends MantineModal>(props: {
        modalKey: TKey;
    } & OpenContextModal<TKey> & DataAttributes) => string;
    ...
    updateContextModal: <TKey extends MantineModal>(props: {
        modalKey: TKey;
    } & Partial<OpenContextModal<TKey>>) => void;
}
export interface MantineModalsOverride {
}
export type MantineModals = MantineModalsOverride extends {
    modals: infer CustomModals;
} ? CustomModals : Record<string, React.FC<ContextModalProps<any>>>;
